...
export function getDictionaryListByPage(params?: any) {
  ...
  return postMethod('/api/dictionary/getDictionaryListByPage', params).then((res) => {
...
export function createDictionary(params: any) {
  ...
  return postMethod('/api/dictionary/createDictionary', params).then((res) => {
...
export function updateDictionary(params: any) {
  ...
  return postMethod('/api/dictionary/updateDictionary', params).then((res) => {
...
export function removeDictionary(params: any) {
  ...
  return postMethod('/api/dictionary/removeDictionary', params).then((res) => {
...
export function createDictionaryItem(params: any) {
  ...
  return postMethod('/api/dictionary/createDictionaryItem', params).then((res) => {
...
export function getDictionaryItemListByDictionaryKeyByPage(params: any) {
  ...
  return postMethod('/api/dictionary/getDictionaryItemListByDictionaryKeyByPage', params).then((res) => {
...
export function removeDictionaryItem(params: any) {
  ...
  return postMethod('/api/dictionary/removeDictionaryItem', params).then((res) => {
...
export function updateDictionaryItem(params: any) {
  // console.log('请求体', params)
  return postMethod('/api/dictionary/updateDictionaryItem', params).then((res) => {
